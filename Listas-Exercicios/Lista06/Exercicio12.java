...
public class Exercicio12 {
    public static String Intervalo(int num) {
        ...
        String Dezena = "", Unidade = "", Centena = "";
        if(num > 99) {
          Centena = num_String.substring(3);
          switch (Centena) {
            case "1": Extenso = "Cem"
              break;
          }    
        ...
        if(num > 19) {
            ...
            switch(Dezena) {
                case "3": Extenso.concat("Trinta");
                    break;
                case "4": Extenso.concat("Quarenta");
                    break;
                case "5": Extenso.concat("Cinquenta");
                    break;
                case "6": Extenso.concat("Sessenta");
                    break;
                case "7": Extenso.concat("Setenta");
                    break;
                case "8": Extenso.concat("Oitenta");
                    break;
                case "9": Extenso.concat("Noventa");
